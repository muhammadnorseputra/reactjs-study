...
export default class Post extends Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <div className="w-full cursor-pointer border-b bg-white mx-3 md:mx-0 my-3 rounded-lg lg:mx-0 hover:bg-gray-100 shadow" data-aos="fade-up" data-aos-delay="100">
